...
class MainScreenState extends State<MainScreen> {
  ...
  var _textEditingControllerLanguage = TextEditingController();
      ...
      body: SafeArea(
        ...
        child: Column(
          children: <Widget>[
            ...
            TextField(
              controller: _textEditingControllerLanguage,
              keyboardType: TextInputType.text,
              textInputAction: TextInputAction.done,
            ),
            Divider(
  ...
  void _pressedSubmitButton() {
    ...
    var language = _textEditingControllerLanguage.text;
    String dateOfBirth =
    ...
    if (fullname.isEmpty) {
      ...
      snackBarInfo = SnackBar(content: Text("Please fill your Language"));
    }
